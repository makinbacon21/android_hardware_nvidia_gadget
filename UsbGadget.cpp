...
#define LOG_TAG "android.hardware.usb.gadget@1.2-service-nv"
...
static V1_0::Status validateAndSetVidPid(uint64_t functions) {
    ...
    std::string vid = property_get("ro.vendor.nv.usb.vid", "0955");

    switch (functions) {
        case static_cast<uint64_t>(V1_2::GadgetFunction::MTP):
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.mtp", "EE02"));
            break;
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::MTP:
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.mtp.adb", "EE03"));
            break;
        case static_cast<uint64_t>(V1_2::GadgetFunction::RNDIS):
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.rndis", "EE08"));
            break;
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::RNDIS:
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.rndis.adb", "EE09"));
            break;
        case static_cast<uint64_t>(V1_2::GadgetFunction::PTP):
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.ptp", "EE04"));
            break;
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::PTP:
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.ptp.adb", "EE05"));
            break;
        case static_cast<uint64_t>(V1_2::GadgetFunction::ADB):
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.adb", "7104"));
            break;
        case static_cast<uint64_t>(V1_2::GadgetFunction::MIDI):
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.midi", "7109"));
            break;
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::MIDI:
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.midi.adb", "710A"));
            break;
        case static_cast<uint64_t>(V1_2::GadgetFunction::NCM):
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.ncm", "7107"));
            break;
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::NCM:
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.ncm.adb", "7108"));
            break;
        /* case static_cast<uint64_t>(V1_2::GadgetFunction::ACCESSORY):
            // can't find this prop
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.accessory", "7105"));
            break; */
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::ACCESSORY:
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.accessory.adb", "7105"));
            break;
        /* case static_cast<uint64_t>(V1_2::GadgetFunction::AUDIO_SOURCE):
            // can't find this prop
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.audio_source", "7106"));
            break; */
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::AUDIO_SOURCE:
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.audio_source.adb", "7106"));
            break;
        /* case V1_2::GadgetFunction::ACCESSORY | V1_2::GadgetFunction::AUDIO_SOURCE:
            // can't find this prop
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.accessory.audio_source", "7106"));
            break;
        case V1_2::GadgetFunction::ADB | V1_2::GadgetFunction::ACCESSORY |
                V1_2::GadgetFunction::AUDIO_SOURCE:
            // can't find this prop
            ret = setVidPid(vid, property_get("ro.vendor.nv.usb.pid.accessory.audio_source.adb", "7106"));
            break; */
        default:
